...
\titulo{Cognitivo: Pensamento Computacional e gamicação no aprendizado de matemática para o Exame Nacional do Ensino Médio (ENEM)}
\data{\the\year}
...
%	\imprimirlistadesimbolos{elementos-pre-textuais/lista-de-simbolos}   
	...
	\input{elementos-textuais/projeto}
