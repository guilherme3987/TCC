...
\termoorientador{1}%Colocar 1 para entrega final de TCC1 e 2 para entrega final de TCC2. Comentar a linha inteira na versão final após correções realizadas pela banca examinadora.
...
%	\imprimirlistadesimbolos{elementos-pre-textuais/lista-de-simbolos}   
	...
	\input{elementos-textuais/correlatos}
