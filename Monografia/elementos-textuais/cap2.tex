...
Para iniciar, vamos testar novamente o uso de siglas: \gls{enem}, \gls{dbr}, \gls{esm}, \gls{ues}, \gls{bncc} e \gls{pc}. Observe que mesmo ao iniciar outro capítulo, as siglas não precisam ser definidas novamente por extenso, pois já foram definidas no capítulo anterior, além de estarem definidas na lista de siglas e abreviaturas.
