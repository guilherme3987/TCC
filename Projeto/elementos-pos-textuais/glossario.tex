...
\newglossaryentry{borboleta}{
	name=Borboleta,
	description={inseto voador, que possui dois pares de asas. São todos os insetos alados da família dos lepidópteros diurnos. São encontradas na natureza com diversas cores e tamanho}
}
